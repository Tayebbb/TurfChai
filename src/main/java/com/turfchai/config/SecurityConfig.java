        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,
                                ...
                                "/api/v1/venues/*/slots",
                                "/api/v1/venues/*/slots/stream").permitAll()
                        .requestMatchers(HttpMethod.GET,
                                "/api/v1/solo/open-games",
                                "/api/v1/solo/open-games/*",
                                "/api/v1/solo/open-games/*/members").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/ai/metrics").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        ...
                        .requestMatchers("/api/v1/owner/**").hasAnyRole("OWNER", "ADMIN", "SUPER_ADMIN")
