...
export const DASHBOARD_SECTIONS = [
  ...
  { path: paths.player.dashboard.bookings, label: 'My bookings', icon: '📅', pending: true },
  ...
  { path: paths.player.dashboard.stats, label: 'Statistics', icon: '📈', pending: true },
  { path: paths.player.dashboard.wallet, label: 'Wallet', icon: '৳', pending: true },
  { path: paths.player.dashboard.notifications, label: 'Notifications', icon: '🔔', pending: true },
